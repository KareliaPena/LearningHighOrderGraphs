function [mat_obj_ifft_tube_dir,R,P,K,norm_R,normPtP,num_of_all_perms,listUnique,NDE] = high_adjacency_constraints_teig_non_uniform(N,M)
...
save([folder '\A_M=' num2str(M) 'N=' num2str(N)],'normPtP','norm_R','mat_obj_ifft_tube_dir','R','P','mat_obj_ifft','K','num_of_all_perms','listUnique','NDE','-v7.3');
end
