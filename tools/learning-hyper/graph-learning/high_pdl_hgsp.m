function[vec_As, vech_As, listUnique,stat] = high_pdl_hgsp(Zs_fft, alpha, beta ,params)
...
if not(isfield(params, 'operators'))
    try
        ...
        [mat_obj_ifft_tube_dir, R, P, K, norm_R, normPtP, num_of_all_perms, listUnique, NDE] = high_adjacency_constraints_teig_non_uniform(N,M);
    end
