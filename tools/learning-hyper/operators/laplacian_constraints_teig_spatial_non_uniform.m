function laplacian_constraints_teig_spatial_non_uniform(N,M)
...
save([folder '\L_N=' num2str(N)],'equal_list','A1','b1','A2','b2','mat_obj','mat_obj2','mat_obj3','mat_obj4','mat_obj_fft','NDE','listUnique','-v7');
end